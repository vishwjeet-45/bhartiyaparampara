...
Route::middleware('guest')->group(function () {
    ...
    Route::post('auth/reset-password', [NewPasswordController::class, 'store'])->name('password.store');

    //these are the custome created routes above are the default created routes which are commented:
     Route::get('auth/register', [UserController::class, 'registerView'])->name('writer.register.view');
     Route::post('auth/register', [UserController::class, 'registerUser'])->name('writer.store.user');
     Route::get('auth/login', [UserController::class, 'loginView'])->name('user.login.view');
     Route::post('auth/login', [UserController::class, 'loginUser'])->name('user.login');
    });
