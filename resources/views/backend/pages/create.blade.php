                ...
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    ...
                    <div class="form-group">
                          ...
                          <input class="form-control" id="slug" type="text" placeholder="Enter page name" name="page_name" value="">
                          @error('page_name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" row="5" col="5" name="meta_description" id="meta_description" placeholder="Enter Meta Description"></textarea>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" row="5" col="5" name="short_description" id="short_description" placeholder="Enter Short Description"></textarea>
                    ...
                    <a id="removeThumbnail" href="javascript:void(0)" class="btn btn-secondary" style="display:none"><i class="fa fa-trash-o"></i></a>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input class="form-control" id="slug" type="text" placeholder="Enter Slug" name="slug" value="">
                          @error('slug')
                            <p style="color:red; font-weight:bold;">{{$message}}</p> 
                          @enderror
                        </div>
