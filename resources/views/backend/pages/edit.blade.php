              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row" action="{{route('admin.pages.update')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" row="5" col="5" name="meta_description" id="meta_description" placeholder="Enter Meta Description">{{$page->meta_description}}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="meta_keywords_container">
                            @php 
                            $keywords = explode(',', $page->meta_keyword);
                            @endphp
                            @for($i = 0; $i < count($keywords); $i++)
                            <div class="metaKeyword">{{$keywords[$i]}}<span class="metaKeywordCloseIcon oldMetaKeywordCloseIcon">x</span></div>
                            @endfor
                           
                            <input type="text" id="meta_keyword_input" placeholder="Add Meta keywords" name="newKeyword">
                            <input type="hidden" id="meta_keywords_value" name="meta_keywords" class="form-control border-error-key_word" value="{{$page->meta_keyword}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" row="5" col="5" name="short_description" id="short_description" placeholder="Enter Short Description">{{$page->short_description}}</textarea>
                        ...
                        <!-- <div class="form-group">
                          ...
                          <input class="form-control" id="slug" type="text" placeholder="Enter Slug" name="slug" value="{{$page->slug}}">
                          @error('slug')
                            <p style="color:red; font-weight:bold;">{{$message}}</p> 
                          @enderror
                        </div> -->
                        ...
                        <div class="form-group">
                          ...
                          <select class="js-example-placeholder-multiple col-sm-12" name="post_language">
                            <option value="">--Select Language--</option>
                            <option value="hi" {{$page->page_language == 'hi' ? 'selected' : ''}}>Hindi</option>
                            <option value="en" {{$page->page_language == 'en' ? 'selected' : ''}}>English</option>
                          </select>
                          @error('post_language')
                            <p style="color:red; font-weight:bold;">{{$message}}</p> 
                          @enderror  
                        ...
                        <div class="form-group">
                          <label class="d-block">Page Status</label>
                          <select class="js-example-placeholder-multiple col-sm-12" name="page_status">
                            <option value="">--Select Language--</option>
                    ...
                    <img id="thumbnailPreview" src="{{url('public/build/assets/upload/thumbnail/pages')}}/{{$page->thumbnail_image}}" alt="Image Preview" style="display: {{$page->thumbnail_image == ''?'none':'block'}}" width="100%">
                    </div>
                    <a id="removeThumbnail" href="javascript:void(0)" class="btn btn-secondary" style="display:none"><i class="fa fa-trash-o"></i></a>
                      ...
                      <div class="form-group">
                          ...
                          <input class="form-control" id="slug" type="text" placeholder="Enter page name" name="page_name" value="{{$page->page_name}}">
                          @error('slug')
                            <p style="color:red; font-weight:bold;">{{$message}}</p> 
                          @enderror
                        </div>
                      ...
                      <div id="container">
                        <textarea id="editor" name="blog_detail_editor">{{$page->page_data}}</textarea>
                        @error('blog_detail_editor')
                            <p style="color:red; font-weight:bold;">{{$message}}</p> 
                             @enderror
                         </div>
