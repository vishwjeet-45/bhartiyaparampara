              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row" action="{{route('admin.other_pages.update', [$page->id])}}" method="POST" enctype="multipart/form-data">
                      @csrf 
                    <div class="col-sm-6">
                    <div class="form-group">
                          <label for="validationCustom01">Page Name:</label>
                          <input class="form-control" id="page_name" type="text" placeholder="Enter page name" name="page_name" value="{{$page->page_name}}">
                          @error('page_name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div id="meta_keywords_container"> 
                            @php
                            $keyword_array = explode(',', $page->meta_keyword); 
                            @endphp
                            @for($i = 0; $i< count($keyword_array); $i++)
                          <div class="metaKeyword">{{$keyword_array[$i]}}<span class="metaKeywordCloseIcon">x</span></div>
                          @endfor  
                    ...
                    <img id="thumbnailPreview" src="{{URL('public/build/assets/upload/thumbnail/other_pages')}}/{{$page->thumbnail_image}}" alt="Image Preview" style="display: block;" width="100%">
                    </div>
                    <a id="removeThumbnail" href="javascript:void(0)" class="btn btn-secondary" style="display:none"><i class="fa fa-trash-o"></i></a>
                      ...
                      <div id="container">
                        <textarea id="editor" name="page_content">{{$page->page_data}}</textarea>
                        @error('page_content')
                            <p style="color:red; font-weight:bold;">{{$message}}</p> 
                             @enderror
                         </div>
