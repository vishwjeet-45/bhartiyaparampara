      ...
      <div class="row">
        ...
        <div class="login-right"  style="width: 50%;">
          <div class="login-card">
            <form class="theme-form login-form" action="{{route('user.login')}}" method="POST"
              style="width:430px !important">
              @csrf
              <div class="login-header text-center">
                <h4 class="m-b-10" style="font-size:25px; font-weight:bold;">Login</h4>
                <h6 style="font-size:12px;">Enter your email and password to login your account</h6>
              </div>
              ...
              <div class="row ">
                <div class="form-group col-md-12">
                  <label for="email" style="font-size:12px;">Your Email<span class="mx-1"
                  ...
                  <span class="error" style="color:red;">{{(Session::get('userNotFound'))}}</span>
                  @endif
                  @error('email')
                ...
                <div class="form-group col-md-12">
                  ...
                  <span class="error" style="color:red;font-size: 12px;">{{(Session::get('wrongPass'))}}</span>
                  @endif
                  @error('password')
                  <span class="error" style="color:red;font-size: 12px;">{{$message}}</span>
                  @enderror
                ...
                <div class="col-md-12">
                  <div class="checkbox">
                    <p style="font-size:10px; " class="text-start">I dont have an account?<a class="px-1"
                ...
                <div class="  col-md-12">
                  <div class="checkbox">
                    <p style="font-size:10px;" class="text-start">Forget Password?<a class="px-1"
