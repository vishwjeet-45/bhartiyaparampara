        ...
        <div style="justify-content:space-between; display:flex; width:100%">
            ...
            <div class="invoice_user_name" style="margin-left:auto;">
                <p
                    ...
                    <b>{{$writerApproveMailData['phone']}}</b></p>
                <p
                    style="margin-top: 0; margin-bottom: 0.5rem; letter-spacing: 1px; word-spacing: 0px; line-height: 26px;">
                    <b>{{$writerApproveMailData['email']}}</b> </p>
            </div>
        </div>
        <hr>
        <div class="main-section" style="text-align:justify;">
            <p>Dear {{$writerApproveMailData['name']}},</p>
            <p>We're excited to inform you that your writer's account on Bhartiya Parampara has been approved by our admin team!
            </p>
            <p>Thank you for your understanding, and we wish you the best in your writing endeavors.</p>  
            <p > <b>Happy Writing!</b> <br> <b>Sincerely,</b> <br> <b>Bhartiya Parampara Team</b> </p>
