...
<body style="background:#e3e9ff; padding-top: 13px; padding-bottom: 20px;">
    ...
    <div class="invoice"
        ...
        <p style="text-align:center; color:green; margin-bottom: 40px; font-weight:700; font-size:20px;">Expiring heading</p> 
        <div class="container">
            ...
            <div class="invoice_user_name" style="margin-left:auto;width:50%;"> 
                <p style="margin-top: 0; margin-bottom: 0.5rem; letter-spacing: 1px; word-spacing: 0px; line-height: 26px;">
                    <b>{{$adsReminderMailData['email']}}</b></p>
                    <p>From: {{ \Carbon\Carbon::parse($adsReminderMailData['start_date'])->format('d M, Y')}}</p> 
                    <p>To: {{ \Carbon\Carbon::parse($adsReminderMailData['end_date'])->format('d M, Y')}}</p>  
            </div>
            </div>
        </div> 
        <hr>
        <div class="main-section" style="text-align: justify;">
            <p>Dear {{$adsReminderMailData['email']}},</p>
            <p>Time is ticking! Seize the chance to advertise on BhartiyaParampara and reach our engaged audience before the opportunity closes in 7 days. Boost your brand visibility by contacting us at [bhartiyaparamparaweb@gmail.com] to secure your spot.</p>
             <p>Don't miss out on this opportunity to make a lasting impression on our engaged community.</p>
             <p>Thank you for considering BhartiyaParampara for your advertising needs.</p>
