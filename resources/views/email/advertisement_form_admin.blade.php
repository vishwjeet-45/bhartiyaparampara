...
<body style="background:#e3e9ff; padding-top: 13px; padding-bottom: 20px;">
    ...
    <div class="invoice"
        ...
        <p style="text-align:center; color:green; margin-bottom: 40px; font-weight:700; font-size:20px;">Advertisement Enquiry | Bhartiya Parampara</p> 
        <div class="container">
        ...
        <div class="container">
            <div style="display:flex">
                ...
                <div style="width:50%;">
                    <p><strong>City</strong>- {{$adFormMailData['city']}}</p>
                    <p><strong>Category</strong>- {{$adFormMailData['category']}}</p>
                    <p><strong>Duration</strong>- {{$adFormMailData['duration']}} Month</p>
                </div>
                <div style="width:50%;">
                    <p><strong>Ad Size</strong>- {{$adFormMailData['size']}}</p>
                    <p><strong>Ad Position</strong>- {{$adFormMailData['position']}}</p>
                </div>
            </div>
        </div>
        <hr>
        <div class="main-section" style="text-align: justify;">
            <p>Hello Admin,</p>
            <p>{{$adFormMailData['comment']}}</p>
            <p>Best regards, <br> Team BhartiyaParampara</p>
            <!-- <p>Best regards, <br> {{$adFormMailData['name']}}</p> -->
            <p></p>
        </div>  
        <hr>
