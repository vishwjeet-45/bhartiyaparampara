...
<body style="background:#e3e9ff; padding-top: 13px; padding-bottom: 20px;">
    ...
    <div class="invoice"
        style="margin:auto; margin-top:50px; background:#fff; padding:10px 30px; min-height:80vh; box-shadow: 1px 1px 6px 2px #a19696; border-radius:0.3rem; min-width:315px; max-width:600px;">
        ...
        <div class="main-section" style="text-align: justify;">
            <h3>Subject:- {{$contactUsMailData['subject']}}</h3>
            <p>Hello Admin,</p>
            <p>{{$contactUsMailData['comment']}}</p>
